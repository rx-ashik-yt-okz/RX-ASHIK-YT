#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To RX ASHIK YT
...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               RX ASHIK YT               |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: RX ASHIK YT    ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mTik Tok : RX_ASHIK_25K  ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: BANGLADESH    ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mASHIK\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:RX ASHIK YT
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:RX ASHIK YT
	print logo
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://www.facebook.com/Md.Ashekur.Islam12?mibextid=ZbWKwL ')
	        menu()
	elif unikers =="3":
		os.system('xdg-open https://youtube.com/@RXASHIKYT.')
                menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mASHIK\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
